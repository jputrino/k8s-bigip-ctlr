...
# COMMONLY USED EXTERNAL LINKS
extlinks = {'home': ('http://clouddocs.f5.com/%s', ''),
            'containers': ('http://clouddocs.f5.com/containers/latest/',
                           ''),
            'k8s': ('http://clouddocs.f5.com/containers/latest/kubernetes/',
                    'k8s '),
            'examples': ('./_static/config_examples/',
                         '')
            }
